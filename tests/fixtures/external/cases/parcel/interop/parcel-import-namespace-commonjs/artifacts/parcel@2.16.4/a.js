...
parcelRegister("g3rg1", function(module, exports) {

$parcel$export(module.exports, "foo", () => $bb0211eb9d4cf748$export$6a5cdcad01c973fa, (v) => $bb0211eb9d4cf748$export$6a5cdcad01c973fa = v);
var $bb0211eb9d4cf748$export$6a5cdcad01c973fa;
$bb0211eb9d4cf748$export$6a5cdcad01c973fa = 2;

});

parcelRegister("aU7fZ", function(module, exports) {

module.exports = (parcelRequire("45Ioh"))($parcel$resolve("iuLRd")).then(()=>parcelRequire('bzj4N'));
...
var $eb8f88e592065d78$exports = {};
$parcel$extendImportMap({
    "iuLRd": "b0.js"
});


var $g3rg1 = parcelRequire("g3rg1");

output = (parcelRequire("aU7fZ")).then(function(b) {
    return (0, $g3rg1.foo) + b.foo;
});
