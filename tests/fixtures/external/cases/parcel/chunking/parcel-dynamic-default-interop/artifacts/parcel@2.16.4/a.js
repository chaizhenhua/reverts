...
parcelRegister("5oWgt", function(module, exports) {
module.exports = 2;

});

parcelRegister("99Y6u", function(module, exports) {

module.exports = (parcelRequire("45Ioh"))($parcel$resolve("7vfbV")).then(()=>parcelRequire('DGo7W'));
...
var $138c0861369f404d$exports = {};
$parcel$extendImportMap({
    "7vfbV": "b0.js"
});


var $5oWgt = parcelRequire("5oWgt");

output = (parcelRequire("99Y6u")).then((b)=>b.out + (0, (/*@__PURE__*/$parcel$interopDefault($5oWgt))));
