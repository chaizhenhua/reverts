...
parcelRegister("8YutG", function(module, exports) {

$parcel$export(module.exports, "compute", () => $688b91929af968bd$export$3b12cb22b12b954b);
function $688b91929af968bd$export$3b12cb22b12b954b(x, q) {
    return q ? x * 2 : x / 2;
}

});

parcelRegister("f5FaK", function(module, exports) {

module.exports = (parcelRequire("45Ioh"))($parcel$resolve("hzOLH")).then(()=>parcelRequire('4szlI'));
...
var $754101fa200236ed$exports = {};
$parcel$extendImportMap({
    "hzOLH": "b0.js"
});


var $8YutG = parcelRequire("8YutG");

var $d80acbf4d33e3697$var$b = (parcelRequire("f5FaK"));
output = $d80acbf4d33e3697$var$b.then(function({ foo: foo, bar: bar }) {
    return (0, $8YutG.compute)(foo, 0) + (0, $8YutG.compute)(bar, 0);
});
