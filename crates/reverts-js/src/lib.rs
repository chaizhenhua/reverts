...
use oxc_ast::{
    ...
    ast::{
        ...
        BindingPatternKind, CallExpression, Class, ClassType, ExportNamedDeclaration, Expression,
        Function, FunctionType, IdentifierReference, ImportDeclaration, ImportDeclarationSpecifier,
        ...
        StaticMemberExpression, UnaryExpression, VariableDeclarationKind,
    },
    visit::walk::{
        walk_assignment_expression, walk_call_expression, walk_export_named_declaration,
        walk_expression, walk_object_property, walk_static_member_expression,
        walk_unary_expression, walk_update_expression,
    },
    visit::walk_mut::{
