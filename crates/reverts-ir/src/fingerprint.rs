...
impl AxisKind {
    ...
    pub const fn as_str(self) -> &'static str {
        match self {
            Self::Ast => "ast",
            Self::Cfg => "cfg",
            Self::NormalizedCfg => "normalized_cfg",
            ...
            Self::ExpressionShape => "expression_shape",
...
pub struct AxisHashes {
    ...
    pub expression_shape: Option<u64>,
...
impl AxisHashes {
    ...
    pub fn get(&self, axis: AxisKind) -> Option<u64> {
        match axis {
            ...
            AxisKind::NormalizedCfg => Some(self.normalized_cfg),
            ...
            AxisKind::ExpressionShape => self.expression_shape,
...
pub enum NormalizationPassId {
    ...
    CommonJsExportBoundaryNormalized,
...
impl NormalizationPassId {
    ...
    pub const fn as_str(self) -> &'static str {
        match self {
            ...
            Self::CommonJsExportBoundaryNormalized => "commonjs_export_boundary_normalized",
