...
pub const COMMAND_SPECS: &[CommandSpec] = &[
    ...
    CommandSpec {
        ...
        summary: "Report semantic-naming completion across public-surface/declarations/full tiers (--gate fails unless the tier is 100% named)",
    },
    CommandSpec {
