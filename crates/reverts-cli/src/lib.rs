...
use reverts_package_matcher::{
    ...
    match_packages_with_pipeline, normalize_hint_text, package_import_names_from_sources,
    package_module_source_quality, package_source_entry_path, package_source_exported_members,
...
mod tests {
    ...
    use super::{
        ...
        best_matching_package_version_by_binary_search, collect_local_package_sources,
        dedup_audit_report, filter_package_sources_to_best_build_variants,
