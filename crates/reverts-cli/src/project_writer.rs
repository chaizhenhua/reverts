...
fn write_typescript_project_scaffold(
    ...
    match source_root {
        Some(root) => {
            ...
            // README.md is intentionally NOT generated here: it carries
            // decompilation provenance and verification results that the
            // skill/agent writes after running the e2e gate. The generator owns
            // only deterministic scaffold.
        }
        None => {
